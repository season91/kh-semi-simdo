 ...
 * @Author : MinHee
 * @Date : 2021. 2. 5.
 * @work : infoChange 메서드 작성, mywritelist jsp와 css 수정, infochange 회원 탈퇴 기능 오류
 *       수정, login.jsp 의 css 수정, join.jsp 상단 SIMDO:wm 로고로 수정, join.jsp css 수정,
 *       /index.do 경로 수정
 */
...
public class UserController extends HttpServlet {
	...
	private void kakaoLoginImpl(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private void naverLogin(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		...
		try {
			...
			if (responseCode == 200) {
				...
				request.getRequestDispatcher("/user/naverloginimpl.do").forward(request, response);
			}
		} catch (Exception e) {
	...
	private void naverLoginImpl(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private void authenticateEmail(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String userEmail = request.getParameter("userEmail");
	...
	private void pwSearch(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/view/user/pw_search.jsp").forward(request, response);
	}

	private void findUserPwEmail(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String userEmail = request.getParameter("userEmail");
		User user = userService.selectUserByEmail(userEmail);
	...
	private void authNumCheck(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	private void userAgreement(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/view/user/user_agreement.jsp").forward(request, response);
	}

	private void ageAgreement(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/view/user/user_age_agreement.jsp").forward(request, response);
	}
	...
	private void infoChange(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/view/user/infochange.jsp").forward(request, response);
	}

	private void infoChangeImpl(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
