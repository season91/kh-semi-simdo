...
public class MovieService {
	...
	public Map<String, Object> parseDb() {
		...
		String url = "http://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_json2.jsp?ServiceKey=RLYJPR31F2X100MT6HX3&query=티모시찰라멧&actor=엘르패닝&detail=Y&collection=kmdb_new2&listCount=1";
	...
	public String parseThumb() {
		...
		String apiURL = "https://openapi.naver.com/v1/search/movie.json?query=" + title +"&yearfrom=2010&yearto=2013"; // json 결과
