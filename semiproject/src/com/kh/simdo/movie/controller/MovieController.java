...
public class MovieController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		case "db.do":
			...
			break;
		case "naviview.do":
			searchNavi(request, response);
			break;
		case "scoreview.do":
			selectMovieByScore(request, response);
			break;
		case "reviewview.do":
			selectMovieByReviewCount(request, response);
			break;
		case "detailview.do":
	...
	// 1. 영화와 후기,명대사 검색
	protected void readMore(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void searchNavi(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void selectMovieByScore(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		int count = 7;
	...
	protected void selectMovieByReviewCount(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
	...
	protected void searchTitle(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
