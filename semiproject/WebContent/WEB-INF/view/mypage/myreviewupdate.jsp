...
<head>
	...
	<link rel="stylesheet" href="/resources/css/mypage/myreviewupdate.css">
</head>
<body>
	...
	<section class="content">
		<div class="content-footer-wrapper">
			<div class="content-wrapper">
				<div class="content-title">후기 수정</div>
				<form class="frm_writereview" action="/mypage/myreviewupdateimpl.do" method="post">
						...
						<div class="writeBox-right">
							<div class="mvInfo-wrapper">
								<div class="mvInfo-left">
									<div class="movieTitle">${requestScope.userReview.mvTitle}</div>
									<div class="movieScore">
										<i class="fas fa-star"></i>
										<input class="input_score" type="number" step="0.1" name="score" min="0.0" max="5.0" required value="${requestScope.userReview.score}">점
									</div>
								</div>
							...
							<div class="wrtieBox-content">
								<textarea class="review-content" name="rvContent" required>${requestScope.userReview.rvContent}</textarea>
							</div>
						</div>
					</div>
