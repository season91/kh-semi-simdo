			...
			<div class="content-wrapper">
				<div class="content-left-wrapper">
					<div class="left-top-wrapper">
						...
						<button class="btn_write" onclick="location.href='/mypage/writereview.do'">등록하기</button>
					</div>
					<c:choose>
				...
				<div class="content-right-wrapper">
					<div class="right-top-wrapper">
						...
						<button class="btn_write" onclick="location.href='/mypage/writeline.do'">등록하기</button>
					</div>
					<c:choose>
							...
							<c:forEach var="fmsline" items="${requestScope.fmslineList}" varStatus="status">
								<div class="fvlineBox">
									...
									<div class="fvlineBox-bottom-wrapper">
										<a href="/mypage/mylineupdate.do?fmslineNo=${fmsline.fmslineNo}"><i class="fas fa-edit revise-content"></i></a>
